...
namespace WSM.ApiECommerce.Migrations
{
    ...
    [Migration("20241221113255_inicial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WSM.ApiECommerce.Entities.Categoria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WSM.ApiECommerce.Entities.DetalhePedido", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WSM.ApiECommerce.Entities.ItemCarrinhoCompra", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WSM.ApiECommerce.Entities.Pedido", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WSM.ApiECommerce.Entities.Produto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WSM.ApiECommerce.Entities.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WSM.ApiECommerce.Entities.DetalhePedido", b =>
                {
                    b.HasOne("WSM.ApiECommerce.Entities.Pedido", "Pedido")
                        .WithMany("DetalhesPedido")
                        .HasForeignKey("PedidoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WSM.ApiECommerce.Entities.Produto", "Produto")
                        .WithMany("DetalhesPedido")
            ...
            modelBuilder.Entity("WSM.ApiECommerce.Entities.ItemCarrinhoCompra", b =>
                {
                    b.HasOne("WSM.ApiECommerce.Entities.Produto", null)
            ...
            modelBuilder.Entity("WSM.ApiECommerce.Entities.Pedido", b =>
                {
                    b.HasOne("WSM.ApiECommerce.Entities.Usuario", null)
                        .WithMany("Pedidos")
            ...
            modelBuilder.Entity("WSM.ApiECommerce.Entities.Produto", b =>
                {
                    b.HasOne("WSM.ApiECommerce.Entities.Categoria", null)
                        .WithMany("Produtos")
